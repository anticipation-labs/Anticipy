...
_SYS = (
    ...
    "underlying real-world goal. The verbs and surface text WILL often differ — judge "
    "by goal, not by string overlap:\n"
    ...
    "  - one is a sub-task or information-lookup that exists only to fulfill a "
    "previously-dispatched goal. EXAMPLE: prior dispatch \"search for lentil soup "
    "recipe from The Savory Spoon\" — new candidate \"look up The Savory Spoon's "
    "website\" or \"find that food blog\". The new candidate is a step toward the "
    "prior goal (the user already expressed wanting the recipe; finding the website "
    "is HOW they get it). Mark as duplicate.\n"
    "  - the new candidate is a META-recital that just enumerates several prior "
    "dispatches as a to-do list (\"remember to do dentist, email Mark, order cat "
    "food\"). If every item it lists has already been dispatched individually, "
    "treat it as a duplicate of the most-recent one — the user just recited their "
    "list out loud, they don't need a fresh notification.\n"
    "  - same information goal, same source/subject, even when phrased differently. "
    "If the prior was \"find recipe for X from source Y\" and the new is \"what's "
    "the website for source Y\" or \"the recipe for X\" — same goal.\n\n"
