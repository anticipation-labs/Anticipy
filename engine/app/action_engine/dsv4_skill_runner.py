...
_DECIDE_SYS = (
    ...
    "button named exactly 'Send' (sometimes 'Send ‪(⌘Enter)‬') at the "
    "bottom-left of the compose window. Use its @eN target_ref. Do "
    "NOT use a keyboard shortcut to send (synthetic Ctrl/Cmd+Enter is "
    "unreliable). Do NOT reopen Compose or re-type fields. After the "
    "click, if the compose window closed or 'Message sent' shows, "
    "action done.\n"
