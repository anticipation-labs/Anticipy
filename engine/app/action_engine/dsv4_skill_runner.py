...
_DECIDE_SYS = (
    ...
    "SLACK specifically: the 'Open' buttons on slack.com/signin are "
    "slack:// desktop-app launchers and do NOTHING in a browser "
    "(clicking them shows no change). To open Slack in the browser, "
    "NAVIGATE directly to https://app.slack.com/ (loads the most "
    "recent signed-in workspace web client) instead of clicking "
    "Open. The session is shared so app.slack.com works even when a "
    "specific name.slack.com domain is shown.\n"
