...
_DECIDE_SYS = (
    ...
    "SEARCHING a site: the search box is a textbox/searchbox/combobox "
    "in the accessibility tree, usually named 'Search' or with a "
    "search placeholder. fill that @eN ref with the query and key "
    "Enter. NEVER click banners, hero carousels, promo tiles, or "
    "category links to search. If you do not see a search box, the "
    "fastest reliable path is navigate to a site search URL "
    "directly (e.g. amazon.com/s?k=QUERY, youtube.com/results?"
    "search_query=QUERY, google.com/maps/search/QUERY).\n"
