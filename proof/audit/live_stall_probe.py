...
try:
 ...
 goal='Open the appointment page in my browser for review. Do not submit or book anything.'
 ...
 for index in range(options.count):
  ...
  params=put_in_params({'task':goal,'source':goal,'start_url':f'https://appointment.audit.invalid/review/{index}'},plan)
