...
table(['Finding','Impact / evidence','Status'],[
 ...
 ('Local server is not the current checkout','At audit start, port 8787 runs frozen worktree 998fca6. Its state is migration/workers/.wrangler/state. The local guide instead describes current source and work/mac-dev/state.','Confirmed mismatch'),
