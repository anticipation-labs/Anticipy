...
// Clean up after myself — second pass.
//
// 1700000014 ran before the simulator walkthrough, and that walkthrough created
// more @anticipy.test accounts while proving signup works on a real device. A
// migration only ever runs once, so the later accounts need their own pass.
//
// This matters beyond tidiness: /auth/claim only adopts old transcripts when
// the instance has exactly ONE account, precisely so nobody is ever handed
// someone else's words. Leftover test accounts would therefore stop Omar's own
// history being claimed onto his account when he signs up.
//
