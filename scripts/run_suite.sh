...
for t in bus workers gateway orchestrator proactive glassbox_scorecard api_hand browser_hand handoff memory memory_capture memory_inject memory_maintain memory_infer memory_selfcheck memory_glue; do
