...
for t in bus workers gateway gateway_retry orchestrator proactive triage triage_clause_scope harmline storesite trigger trigger_notify duetime decider deferred_persistence pending_persistence ask_roundtrip ask_debounce annoyance frontend_api glassbox_scorecard api_hand browser_hand handoff channels channel_worker inbound memory memory_capture memory_inject memory_maintain memory_infer memory_selfcheck memory_glue owner_mode owner_onboarding owner_ingest_event; do
