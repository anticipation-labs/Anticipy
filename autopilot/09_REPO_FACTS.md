...
- Holdout burn accounting: reading, opening, transcribing, attempting, or using a held-out file as verdict evidence burns it. A verdict inventory list of available filenames does not burn every listed file. This distinction exists because lap `20260606T013339Z` blocked on over-strict inventory accounting.
