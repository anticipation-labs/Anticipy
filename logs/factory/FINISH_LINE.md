...
| ❌ | A real inbound text was answered by the brain (round-trip) | **NOT_REAL** | never observed: an inbound text from the owner answered by the brain |
| ✅ | The account-scrape onboarding actually fired once | **REAL** | an onboarding account-scrape actually fired (glass-box onboard_discover) |
| 🙋 | 5 real owner days, 0 vent-actions (the finish line) | **NEEDS_OMAR** | 5 consecutive real Omar days through the live system, 0 vent-actions (his call to run) |
