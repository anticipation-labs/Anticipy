...
- Prior amended judge proofs exist through `logs/verdicts/20260606T070041Z.md`. Each kept proof includes planted-fake self-check, computer-use self-test, tamper scan, different-family OpenRouter cross-check, and a separate verdict. None verified an M0 real artifact.
...
- Latest judged held-out run: `20260606T070041Z`, `act=31`, `ask=271`, `ignore=1690`; verified external artifacts: 0.
- Latest builder-visible realday run: `20260606T082329Z`, `act=28`, `ask=385`, `ignore=2815`; verified external artifacts: 0 because judge has not ruled.
...
- Lap `20260606T082329Z` ran builder-visible raw audio only. The builder did not read holdout. The Steve Jobs / Bill Gates interview is a silence control only and never counts for task completion.
