...
async function refresh() {
  ...
  try {
    ...
    say("backendText", "Connected to Anticipy Claude Version.");
  } catch (e) {
    dot.classList.remove("on");
    // Nobody reading this runs a backend. Say what's true and what happens next.
    say("backendText", "I can't reach Anticipy Claude Version from here yet — I'll keep trying. Your code appears the moment I'm through.");
  }
  ...
  say("codeHead", "Type this code into the Anticipy Claude Version app on your iPhone");
  ...
  hint(pairCode ? "Click the code to copy it." : "Your code appears here as soon as I reach Anticipy Claude Version.", 0);
