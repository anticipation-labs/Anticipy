...
// Kept exported so the answer route and tests can re-import the same
// question list. Phrasing matches the local INTERVIEW_SCRIPT closely;
// it is simplified for a Polly TTS voice that does not handle long
// parentheticals well.
